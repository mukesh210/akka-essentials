...
//
//  //implicit val executionContext = system.dispatcher or
...
//  }
  ...
  /**
    ...
    *
    * - if actor receives a message(anything), you have 1 second to send it another message
...
//  }
  ...
  /**
    * scheduling message to itself - Timer
    */
  ...
  class TimerBasedHearbeatActor extends Actor with ActorLogging with Timers {
    ...
    override def receive: Receive = {
      case Start =>
        ...
        // if we are using same TimerKey, earlier Timer associated with this TimerKey will be cancelled automatically
